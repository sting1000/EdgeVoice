...
# 特征提取参数（核心）
N_MFCC = 20  # MFCC系数数量，增加可提供更多频域细节，推荐范围：13-40
...
CONFORMER_LAYERS = 3  # 层数，增加可提高模型容量，也增加计算量，推荐范围：2-6
CONFORMER_ATTENTION_HEADS = 8  # 注意力头数，通常为2的幂，推荐范围：4-16
CONFORMER_HIDDEN_SIZE = 160  # 隐藏层大小，影响模型容量，推荐为16的倍数（满足硬件优化）
CONFORMER_CONV_KERNEL_SIZE = 15  # 卷积核大小，影响感受野，推荐范围：9-31（奇数）
...
# 流式处理参数（核心，影响实时推理）
STREAMING_CHUNK_SIZE = 20  # 每次处理的帧数，减小可降低延迟但可能降低准确率，推荐范围：10-30
MAX_CACHED_FRAMES = 60  # 历史缓存帧数，增加可保留更多上下文，推荐范围：40-100
STREAMING_STEP_SIZE = 10  # 步长，影响特征重叠率，推荐范围：5-20
