...
|---------|--------------|---------------|---------|
| **算力需求** | 0.6 GFLOPS | 1-2 GFLOPS | 1-2.5 GFLOPS |
| **内存占用** | 40-50MB | 30-40MB | 峰值<80MB |
| **存储需求** | 3-5MB | 8-10MB | 总计<15MB |
| **功耗消耗** | 50-70mW | 60-80mW | 持续模式<120mW |
